...
class AnimeRecommendationHandler : MessageHandling {
    ...
    private fun createTree() : Node {
        ...
        fun getActionTree() : Node {
            ...
            val pureFun = Node("Ready for the joyride?", arrayListOf("Hell yeah", "HELL YEAH!", "Eyegasm", "Eargasm", "Foodgasm", "Cartoon", "Tribute to superheroes", "Zombie apocalypse", "How stupid can it get?", "Oldschool comic style"))
            ...
            roadTripAdventure.attach(tengenToppaGurrenLagann, fmab, cowboyBebop, baccano, katanagatari, lastExile, samuraiChamploo, rurouniKenshin, twelveKingdoms)


            val notReallySupernaturalWayPoint = createWaypointNode(arrayListOf(
            ...
            val darkerThanBlack = LeafNode("Darker than Black", "https://myanimelist.net/anime/2025/Darker_than_Black__Kuro_no_Keiyakusha")
            // Tengen node already created
            val medievalFantasyWayPoint = createWaypointNode(arrayListOf(
                LeafNode("Rage of Bahamut: Genesis", "https://myanimelist.net/anime/21843/Shingeki_no_Bahamut__Genesis"),
                LeafNode("Slayers", "https://myanimelist.net/anime/534/Slayers")))
            // fma node already created
            val urbanFantasyWayPoint = createWaypointNode(arrayListOf(
            ...
            val magicalGirlsWayPoint = createWaypointNode(arrayListOf(
            ...
            fullBlownAction.attach(notReallySupernaturalWayPoint, darkerThanBlack, tengenToppaGurrenLagann, medievalFantasyWayPoint, fmab, urbanFantasyWayPoint, kenichi, yuYuHakusho, magicalGirlsWayPoint, scienceFiction, samuraiWayPoint)


            val shootOutWayPoint = WaypointNode(arrayListOf(
            ...
            val mechaFilter = Node("What sounds interesting?", arrayListOf("Road trip", "Neo-noir", "Mindgames", "Pacific Rim", "Comedy", "Romance", "A sci-fi serenade"))
            ...
            val visionOfEscaflowne = LeafNode("Vision of Escaflowne", "https://myanimelist.net/anime/182/Tenkuu_no_Escaflowne")
            ...
            val classicsFilter = Node(sportQuery, arrayListOf("Boxing", "Racing", "Basketball", "Baseball", "Baseball + gambling", "Go"))
            val freshFilter = Node(sportQuery, arrayListOf("Basketball", "Baseball", "Cycling", "Tennis", "Volleyball", "Swimming", "American football", "Poetry card game"))
            ...
            freshFilter.attach(kurokoNoBasket, aceOfDiamond, yowamushiPedal, babySteps, haikyuu, free, eyeshield21, chihayafuru)
            ...
            val pantyStocking = LeafNode("Panty & Stocking", "https://myanimelist.net/anime/8795/Panty___Stocking_with_Garterbelt")
            val samuraiFlamenco = LeafNode("Samurai Flamenco", "https://myanimelist.net/anime/19365/Samurai_Flamenco")
            val highschoolOfTheDead = LeafNode("Highschool of the Dead", "https://myanimelist.net/anime/8074/Highschool_of_the_Dead")
            val crossAnge = LeafNode("Cross Ange", "https://myanimelist.net/anime/25731/Cross_Ange__Tenshi_to_Ryuu_no_Rondo")
            val jjba = LeafNode("JoJo's Bizarre Adventure", "https://myanimelist.net/anime/14719/JoJo_no_Kimyou_na_Bouken_TV")

            pureFun.attach(flcl, killLaKill, noGameNoLife, symphogear, shokugekiNoSouma, pantyStocking, samuraiFlamenco, highschoolOfTheDead, crossAnge, jjba)

            return actionAdventure
        }


        root.attach(getActionTree())
