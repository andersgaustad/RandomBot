...
private const val bubapediaRoot = "https://bulbapedia.bulbagarden.net"
...
class PokemonFixedParser : Parsing {
    override fun parseRawFile(fromPath: String, toPath: String) {
        ...
        println("Reading from $fromPath")
        val raw = File(fromPath).readLines()
        println("File read!")
        val pokePrefix = "<td> <a href=\"/wiki/"
        val generationPrefix = "id=\"Generation_"
